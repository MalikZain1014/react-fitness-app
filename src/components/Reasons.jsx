...
const Reasons = () => {
  return (
    <section
      id="reasons"
      className="gap-y-11 xl:gap-y-0 grid grid-cols-6 justify-between px-5 pb-20"
    >
      ...
      <div
        dir="rtl"
        className="my-11 lg:my-0 grid justify-center lg:justify-normal col-span-6 lg:col-span-3"
      >
