  ...
  return (
    <section className="flex flex-col p-5 lg:flex-row">
      ...
      <div className="flex flex-col items-center lg:items-start flex-1 gap-y-6 text-center lg:text-start pt-11 lg:pt-0">
        <h1 className="font-bold text-xl capitalize mb-5 text-slate-800 dark:text-slate-300">
          {name}
        </h1>
        ...
        {extraDetail.map((item) => (
          <span
            key={item.icon}
            className="flex flex-col gap-y-7 w-40 lg:w-auto pt-5 lg:pt-0"
          >
            <div className="flex items-center gap-x-3">
              ...
              <h2 className="text-slate-800 capitalize dark:text-slate-300">
                {item.name}
              </h2>
            </div>
          </span>
